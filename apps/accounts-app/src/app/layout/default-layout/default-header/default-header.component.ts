import { AsyncPipe, NgIf, TitleCasePipe, NgTemplateOutlet } from '@angular/common';
...
import { AuthService, User, Tenant } from '../../../core/services/auth.service';
import { Observable } from 'rxjs';

@Component({
  selector: 'acc-default-header',
